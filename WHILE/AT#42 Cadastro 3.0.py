...
while True:
    ...
    #Consulta de Matriculas Realizadas.
        ...
        if excluir not in list_matricula:
            ...
            del list_sobname[excluir-1]
            del list_end[excluir-1]
            del list_bairro[excluir-1]
            del list_cid[excluir-1]
            del list_estado[excluir-1]
            del list_pais[excluir-1]
            del list_fone[excluir-1]
            del list_cpf[excluir-1]
            del list_peso[excluir-1]
            del list_altura[excluir-1]
            del list_idade[excluir-1]
            del list_numCartao[excluir-1]
            del list_email[excluir-1]
            del list_cep[excluir-1]
            del list_nota1[excluir-1]
            del list_nota2[excluir-1]
            del list_nota3[excluir-1]
            del list_nota4[excluir-1]
            del list_media[excluir-1]
            del list_serie[excluir-1]
            del list_classe[excluir-1]
            del list_sexo[excluir-1]
            del list_cor[excluir-1]
            print("+"+"="*25+"+")
