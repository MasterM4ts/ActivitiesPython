...
select SALARIO from VENDEDOR where SALARIO = (select min(SALARIO) from VENDEDOR);
select NOMEVEND,SALARIO from VENDEDOR where SALARIO = (select min(SALARIO) from VENDEDOR);
select NUMPED, CODVEND from PEDIDO where CODVEND = (select max(CODVEND) from PEDIDO);
