...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Área do Circulo")
        self.setGeometry(100, 100, 300, 150)


        self.label1 = QLabel("Raio do Circulo:", self)
    ...
    def calculo_area(self):
        raio = float(self.input1.text())
        calculo = (raio**2) * 3.14
        self.result_label.setText(f"A Área do Circulo é: {calculo}")
